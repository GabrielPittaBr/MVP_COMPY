...
| places                   | read: if signedIn()           | mantida como reserva documentada + write: if false. O comentário avisa que nenhum código aponta para lá e que isso é proposital (catálogo em código, tarefa 6)                                                                                                                                       |
